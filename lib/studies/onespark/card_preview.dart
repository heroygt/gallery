...
import 'package:gallery/studies/onespark/task_detail_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return OpenContainer(
      openBuilder: (context, closedContainer) {
        return TaskDetailPage(id: id, task: email);
      },
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "${email.key}, ${email.summary}",
                              style: textTheme.headline6,
                            ),
                            const SizedBox(height: 16),
                            // Text("${email.status}", style: textTheme.headline5),
                            SvgPicture.asset(
                              "assets/ee.svg"
                            ),
                            const SizedBox(height: 16),
