...
import 'package:gallery/studies/onespark/adaptive_nav.dart';
...
import 'package:gallery/studies/onespark/routes.dart' as routes;
...
class _RestorableEmailState extends RestorableListenable<TaskStore> {
  @override
  TaskStore createDefaultValue() {
    return TaskStore();
  }

  @override
  TaskStore fromPrimitives(Object data) {
    final appState = TaskStore();
