...
import 'package:gallery/studies/onespark/app.dart';
import 'package:gallery/studies/onespark/bottom_drawer.dart';
import 'package:gallery/studies/onespark/colors.dart';
import 'package:gallery/studies/onespark/compose_page.dart';
import 'package:gallery/studies/onespark/mailbox_body.dart';
...
import 'package:gallery/studies/onespark/search_page.dart';
import 'package:gallery/studies/onespark/waterfall_notched_rectangle.dart';
...
class _AdaptiveNavState extends State<AdaptiveNav> {
  ...
  Widget build(BuildContext context) {
    ...
    final _folders = <String, String>{
      '待开发': _folderIconAssetLocation,
      '开发中': _folderIconAssetLocation,
      '已提测': _folderIconAssetLocation,
      '测试中': _folderIconAssetLocation,
      '测试通过': _folderIconAssetLocation,
      '待上线': _folderIconAssetLocation,
      '已上线': _folderIconAssetLocation,
    };
  ...
  void _onDestinationSelected(int index, MailboxPageType destination) {
    var emailStore = Provider.of<TaskStore>(
      context,
      listen: false,
    );
  ...
  Widget build(BuildContext context) {
    return _SharedAxisTransitionSwitcher(
      defaultChild: Scaffold(
        ...
        bottomNavigationBar: Consumer<TaskStore>(
          builder: (context, model, child) {
...
class _AnimatedBottomAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<TaskStore, bool>(
...
class _MailNavigatorState extends State<_MailNavigator> {
  static const inboxRoute = '/onespark/inbox';
...
class _ReplyFabState extends State<_ReplyFab>
  ...
  void onPressed() {
    var onSearchPage = Provider.of<TaskStore>(
      context,
      listen: false,
    ).onSearchPage;
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<TaskStore, bool>(
      ...
      builder: (context, onMailView, child) {
        ...
        final tooltip = onMailView ? '快速处理' : '新建任务';
