...
<!--
  ...
  It is based on lib/l10n/intl_zh.arb.
-->
<resources>
''';
...
///
/// Note that the filename for `intl_zh_CN.xml` is used by the internal
...
/// unless necessary.
Future<void> arbsToXmls({bool isDryRun = false}) async {
  final output =
      isDryRun ? stdout : File('$_l10nDir/intl_zh_CN.xml').openWrite();
  await generateXmlFromArb(
    inputArb: File('$_l10nDir/intl_zh.arb'),
    outputXml: output,
